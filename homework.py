...
cash_calculator = CashCalculator(10000)  # limit
...
# calories_calc.add_record(Record(amount=501,
#                                     comment='сыр',
#                                     ))

# calories_calc.add_record(Record(amount=500,
#                                     comment='sa',
#                                     ))

# calories_calc.get_calories_remained()

# cash_calculator.add_record(Record(amount=2500,
#                                    comment='бар в Шмантупе др',
#                                    date='17.05.2021'))

# cash_calculator.add_record(Record(amount=2500,
#                                    comment='бар в Аляске др',
#                                    date='01.05.2021'))

# cash_calculator.add_record(Record(amount=543,
#                                    comment='бар в Сингапуре др',
#                                    date='16.05.2021'))

# s = Record(amount=2501, comment='бар в Сюрене др')
# print(s.show())
# cash_calculator.get_today_stats()
